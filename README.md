...
|---------------|----------------|---------------------------------|-------------------|
| 16.00 - 16.15   | Introduction   | TBA                | Ioannis Papoutsis |
| 16.15 - 17.30  | Spatiotemporal Datacubes for Earth System Modeling | TBA  | Ioannis Prapas    |
| 17.30 - 18.15 | Advanced ML methods for Damage Assessment | TBA                | Nikolaos Bountos, Maria Sdraka  |
| 18.15 - 19.00 |  Probabilistic ML in Natural Hazards| TBA  | Spyros Kondylatos |

Link to material: TODO
